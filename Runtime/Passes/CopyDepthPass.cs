...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    public class CopyDepthPass : ScriptableRenderPass
    {
        ...
        public override void OnCameraSetup(CommandBuffer cmd, ref RenderingData renderingData)
        {
            ...
            ConfigureTarget(new RenderTargetIdentifier(destination.Identifier(), 0, CubemapFace.Unknown, -1), /*descriptor.depthStencilFormat*/descriptor.graphicsFormat, descriptor.width, descriptor.height, descriptor.msaaSamples, true);
