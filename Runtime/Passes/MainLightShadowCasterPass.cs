...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    public class MainLightShadowCasterPass : ScriptableRenderPass
    {
        ...
        {
            ConfigureTarget(new RenderTargetIdentifier(m_MainLightShadowmapTexture), /*m_MainLightShadowmapTexture.depthStencilFormat*/m_MainLightShadowmapTexture.graphicsFormat, renderTargetWidth, renderTargetHeight, 1, true);
